...
@WebServlet("/ViewDocToDeleteServlet")
public class ViewDocToDeleteServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(isTrue == true) {
			...
			RequestDispatcher dis = request.getRequestDispatcher("doctordelete.jsp");
