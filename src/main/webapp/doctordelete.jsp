...
<link rel = "stylesheet" type = "text/css" href = "doctordelete.css">
</head>
<body>
	...
	<c:url value = "delete.jsp" var = "docdelete">
	...
	<a href = "${docdelete}">
	<input type = "button" name = "update" value = "Delete Doc Details" id = "btn">
	</a>
</body>
</html>